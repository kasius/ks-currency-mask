...
var KsCurrencyMaskDirective = (function () {
    function KsCurrencyMaskDirective(elementRef, la, currencyPipe) {
        this.elementRef = elementRef;
        this.la = la;
        this.currencyPipe = currencyPipe;
        this.fraction = { fractionSize: 2, round: false };
        this.decimal = false;
    ...
    KsCurrencyMaskDirective.prototype.ngDoCheck = function () {
